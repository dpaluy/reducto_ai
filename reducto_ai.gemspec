...
Gem::Specification.new do |spec|
  ...
  spec.description = "ReductoAI provides a lightweight Faraday-based wrapper for Reducto's Parse, Split, Extract, Edit, and Pipeline endpoints including async helpers and Rails-friendly configuration."
